...
namespace Serveo.Infrastructure.Migrations
{
    ...
    [Migration("20260829075206_UpdateMenuR")]
    partial class UpdateMenuR
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Serveo.Domain.Entities.Authorization.ApiClient", b =>
                {
                    ...
                    b.Property<Guid?>("BusiniessId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("businiess_id");
            ...
            modelBuilder.Entity("Serveo.Domain.Entities.Authorization.ApiClientKey", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_api_client_keys");

                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_api_client_keys_client_id");

                    b.HasIndex("KeyHash")
                        .IsUnique()
                        .HasDatabaseName("ix_api_client_keys_key_hash");

                    b.ToTable("api_client_keys");
                });
            ...
            modelBuilder.Entity("Serveo.Domain.Entities.Catalog.MenuCategory", b =>
                {
                    ...
                    b.HasIndex("MenuId", "CategoryId")
                        .IsUnique()
                        .HasDatabaseName("ix_menu_categories_menu_id_category_id");
            ...
            modelBuilder.Entity("Serveo.Domain.Entities.Catalog.MenuProduct", b =>
                {
                    ...
                    b.HasIndex("MenuId", "ProductId")
                        .IsUnique()
                        .HasDatabaseName("ix_menu_products_menu_id_product_id");
            ...
            modelBuilder.Entity("Serveo.Domain.Entities.Authorization.ApiClientKey", b =>
                {
                    b.HasOne("Serveo.Domain.Entities.Authorization.ApiClient", "Client")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_api_client_keys_api_clients_client_id");
